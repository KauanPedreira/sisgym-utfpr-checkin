...
export type Database = {
  ...
  public: {
    Tables: {
      alunos: {
        Row: {
          ...
          tipo_vinculo: Database["public"]["Enums"]["student_type"]
      ...
      presencas: {
        ...
        Relationships: [
          {
            foreignKeyName: "presencas_qrcode_id_fkey"
            columns: ["qrcode_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      increment_attendance: { Args: { user_id: string }; Returns: undefined }
    }
    Enums: {
      app_role: "aluno" | "admin" | "funcionario"
      student_status: "ativo" | "inativo" | "bloqueado"
      student_type: "aluno" | "servidor" | "externo"
    }
    CompositeTypes: {
      [_ in never]: never
    }
